...
typedef struct  {
	...
	float Accelerometer_X_Mult;     /*!< deg value X axis */
	float Accelerometer_Y_Mult;     /*!< deg value Y axis */
	float Accelerometer_Z_Mult;     /*!< deg value Z axis */
	float Gyroscope_X_Mult;     /*!< deg value X axis */
	float Gyroscope_Y_Mult;     /*!< deg value Y axis */
	float Gyroscope_Z_Mult;     /*!< deg value Z axis */
	float Deg_X;     /*!< deg value X axis */
	float Deg_Y;     /*!< deg value Y axis */
	float Deg_Z;     /*!< deg value Z axis */
