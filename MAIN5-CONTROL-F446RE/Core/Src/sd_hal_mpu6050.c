...
SD_MPU6050_Result SD_MPU6050_ReadDeg(I2C_HandleTypeDef* I2Cx,SD_MPU6050* DataStruct,float dt)
{
	uint8_t data[14];
	int16_t temp;
	uint8_t reg = MPU6050_ACCEL_XOUT_H;
	...
	DataStruct->Deg_X += DataStruct->Gyroscope_X*DataStruct->Gyro_Mult*dt;
	DataStruct->Deg_Y += DataStruct->Gyroscope_Y*DataStruct->Gyro_Mult*dt;
	if(DataStruct->Gyroscope_Z*0.01*DataStruct->Gyro_Mult>0.01 || DataStruct->Gyroscope_Z*0.01*DataStruct->Gyro_Mult< -0.01)
		DataStruct->Deg_Z += DataStruct->Gyroscope_Z*DataStruct->Gyro_Mult*dt;
...
SD_MPU6050_Result SD_MPU6050_ReadAll_Mult(I2C_HandleTypeDef* I2Cx,SD_MPU6050* DataStruct)
{
	uint8_t data[14];
	int16_t temp;
	uint8_t reg = MPU6050_ACCEL_XOUT_H;
	...
	/* Mult */
	DataStruct->Accelerometer_X_Mult=DataStruct->Accelerometer_X*DataStruct->Acce_Mult;
	DataStruct->Accelerometer_Y_Mult=DataStruct->Accelerometer_Y*DataStruct->Acce_Mult;
	DataStruct->Accelerometer_Z_Mult=DataStruct->Accelerometer_Z*DataStruct->Acce_Mult;
	DataStruct->Gyroscope_X_Mult=DataStruct->Gyroscope_X*DataStruct->Gyro_Mult;
	DataStruct->Gyroscope_Y_Mult=DataStruct->Gyroscope_Y*DataStruct->Gyro_Mult;
	DataStruct->Gyroscope_Z_Mult=DataStruct->Gyroscope_Z*DataStruct->Gyro_Mult;
